...
from alpha.utils import humanbytes, time_formatter, sort_file_name_key
...
@alpha.on_cmd('drename ([^|]+)\|([^|]+)', about={  # noqa
...
@alpha.on_cmd(r'split (\d+) ([\s\S]+)', about={
    'header': "Split files",
