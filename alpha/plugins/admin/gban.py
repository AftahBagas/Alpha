...
async def gban_user(message: Message):
    ...
    if user_id in Config.SUDO_USERS:
        await message.edit(
            "Dia adalah sudo users Alpha, Tidak bisa banned dia.\n\n"
...
@alpha.on_filters(filters.group & filters.new_chat_members, group=1, check_restrict_perm=True)
