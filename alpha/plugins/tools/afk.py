...
from alpha import petercord, Message, filters, Config, get_collection
...
@alpha.on_filters(IS_AFK_FILTER & ~filters.me & ~filters.bot & ~filters.edited & (
