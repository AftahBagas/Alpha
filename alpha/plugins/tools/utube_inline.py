...
PATH = "./alpha/xcache/ytsearch.json"
...
async def get_ytthumb(videoid: str):
    ...
    thumb_link = "https://imgur.com/gallery/ieSTXbM"
...
async def iytdl_inline(message: Message):
    ...
    if message.client.is_bot:
        ...
        await petercord.bot.send_photo(
            message.chat.id,
            photo=photo,
            caption=caption,
        ...
        bot = await alpha.bot.get_me()
        x = await alpha.get_inline_bot_results(bot.username, f"ytdl {input_url}")
        await message.delete()
...
if alpha.has_bot:
    ...
    async def ytdl_download_callback(c_q: CallbackQuery):
        ...
        upload_msg = await alpha.send_message(Config.LOG_CHANNEL_ID, "Uploading...")
        ...
        refresh_vid = await petercord.bot.get_messages(
