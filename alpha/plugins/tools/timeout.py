...
@alpha.on_cmd("vdelto", about={'header': "View auto message delete timeout"})
...
@alpha.on_cmd("vwelto", about={'header': "View auto welcome/left message delete timeout"})
...
@alpha.on_cmd("vapicto", about={'header': "View auto profile picture timeout"})
...
@alpha.on_cmd("vesto", about={'header': "View edit sleep timeout"})
