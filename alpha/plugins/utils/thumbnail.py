...
from alpha import alpha, Config, Message, get_collection
...
@alpha.on_cmd('dthumb', about={'header': "Delete thumbnail"}, allow_channels=False)
...
@alpha.on_cmd('vthumb', about={'header': "View thumbnail"}, allow_channels=False)
