...
if "Alpha" in _RUN(_MGCLIENT.list_database_names()):
    _LOG.info(_LOG_STR, "Alpha Database Found :) => Now Logging to it...")
else:
    _LOG.info(_LOG_STR, "Alpha Database Not Found :( => Creating New Database...")
