...
class Message(RawMessage):
    """ Modded Message Class For Alpha """
    def __init__(self,
    ...
    @classmethod
    def parse(cls, client: Union['_client.Alpha', '_client.AlphaBot'],
    ...
    @property
    def client(self) -> Union['_client.Alpha', '_client.AlphaBot']:
        """ returns client """
        return self._client
