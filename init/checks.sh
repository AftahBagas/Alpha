...
_checkDefaultVars() {
    ...
    declare -rA def_vals=(
        ...
        [UPSTREAM_REPO]="https://github.com/AftahBagas/Alpha"
...
_setupPlugins() {
    ...
    if test $(grep -P '^'$2'$' <<< $3); then
        ...
        rm -rf alpha/plugins/$path/
        mv $tmp/plugins/ alpha/plugins/$path/
...
_checkUnoffPlugins() {
    _setupPlugins Xtra true $LOAD_UNOFFICIAL_PLUGINS https://github.com/AftahBagas/AlphaPlugins.git
}
